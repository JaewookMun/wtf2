...
(function (factory) {
	if (typeof define === "function" && define.amd) {
		...
		define([
			"jquery",
			"static/modules/fancytree-2.38.3/jquery-ui-dependencies/ui/widgets/draggable",
			"static/modules/fancytree-2.38.3/jquery-ui-dependencies/ui/widgets/droppable",
			"./jquery.fancytree",
		], factory);
	} else if (typeof module === "object" && module.exports) {
		// Node/CommonJS
